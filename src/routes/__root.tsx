...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Charis Panayides — Web Design Portfolio" },
      {
        name: "description",
        content:
          "Selected web design and WordPress projects by Charis Panayides — editorial, minimal, quietly crafted.",
      },
      { name: "author", content: "Charis Panayides" },
      { property: "og:title", content: "Charis Panayides — Web Design Portfolio" },
      {

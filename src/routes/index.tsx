    ...
    <div className="relative z-10 min-h-screen text-foreground">
      ...
      <section className="relative mx-auto max-w-[1400px] px-6 pb-24 pt-16 md:px-12 md:pb-40 md:pt-32">
        ...
        <motion.div
          ...
          className="relative mt-16 flex flex-col items-start gap-6 border-t border-hairline pt-6 md:absolute md:bottom-24 md:right-12 md:mt-0 md:flex-row md:items-end md:gap-10 md:border-t-0 md:pt-0"
        >
